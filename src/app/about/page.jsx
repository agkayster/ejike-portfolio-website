			...
			<div className='h-full overflow-scroll lg:flex' ref={containerRef}>
				...
				lg:w-2/3 lg:pr-0'>
					...
					<div className='flex flex-col gap-12 justify-center'>
						...
						<p className='text-lg'>
							I am a warm and friendly software developer with 4
							years of experience in robust problem-solving and 1
							year experience in automation and AI/Machine
							learning skills coupled with creating and designing
							software in a test-driven environment. I started my
							Software enigneering journey in 2019 at General
							Assembly, London and since then, I have never looked
							back. My drive to provide solutions to problems and
							overcome challenges leads me to search for a role
							that combines analytical reasoning, innovation,
							creativity and fun.
						</p>
						{/* BIOGRAPHY QUOTE */}
					...
					<div
						...
						<motion.div
							...
							<div className='w-1/3'>
								...
								<p className='p-3 text-sm italic'>
									I build mobile and web applications to solve
									problems.
								</p>
								{/* LEFT JOB DATE */}
						...
						<div className='flex flex-row justify-between h-48'>
							...
							<div className='w-1/3'>
								...
								<p className='p-3 text-sm italic'>
									I worked in a cross-functional team with
									other Software Engineers to build a
									Famelab/Fameapp portal that integrates with
									LinkedIn.{' '}
								</p>
								{/* RIGHT JOB DATE */}
								<p className='p-3 text-red-400 text-xs md:text-sm font-semibold'>
						...
						<div className='flex flex-row justify-between h-48'>
							...
							<div className='w-1/3'>
								...
								{/* RIGHT JOB DESCRIPTION */}
								<p className='p-3 text-sm italic'>
									I built responsive web applications for the
									Bavarian ministry of transport and for a
									private Pet insurcance organization in
									munich, Germany{' '}
								</p>
								{/* RIGHT JOB DATE */}
								<p className='p-3 text-red-400 text-xs md:text-sm font-semibold'>
